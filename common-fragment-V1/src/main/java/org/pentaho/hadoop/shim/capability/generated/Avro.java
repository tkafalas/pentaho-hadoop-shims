...
public class Avro {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, Avro.NOT_FOUND_VALUE);
        if (Avro.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public String toString() {
        ...
        sb.append(Avro.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("enabled");
        sb.append('=');
