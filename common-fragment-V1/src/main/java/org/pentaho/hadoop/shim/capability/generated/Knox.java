...
public class Knox {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, Knox.NOT_FOUND_VALUE);
        if (Knox.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public String toString() {
        ...
        sb.append(Knox.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("enabled");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Knox) == false) {
            return false;
        }
        Knox rhs = ((Knox) other);
